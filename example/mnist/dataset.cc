...
MNISTDataset::MNISTDataset(const std::string &dataset, bool train)
    : image_file_(ReadSN3PascalVincentFile(std::format("{}/{}-images-idx3-ubyte", dataset, train ? kTrainPrefix : kTestPrefix))),
      label_file_(ReadSN3PascalVincentFile(std::format("{}/{}-labels-idx1-ubyte", dataset, train ? kTrainPrefix : kTestPrefix))),
